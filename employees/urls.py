...
urlpatterns = [
    ...
    path('api/department/<int:pk>', DepartmentDetailViewSet.as_view(),name='department-detail-api'),
    path('api/department', DepartmentViewSet.as_view(),name='department-api'),
